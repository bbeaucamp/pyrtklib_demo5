...
PYBIND11_MODULE(pyrtklib5, m) {
    ...
    py::class_<ssat_t>(m,"ssat_t").def(py::init())
        ...
        .def_property_readonly("dion",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.dion,MAXITR);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("dtrp",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.dtrp,MAXITR);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("clkcorr",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.clkcorr,MAXITR);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("weight",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.weight,MAXITR);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("vare",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.vare,MAXITR);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("vmeas",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.vmeas,MAXITR);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("vion",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.vion,MAXITR);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("vtrp",[](ssat_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.vtrp,MAXITR);return tmp;},py::return_value_policy::reference)
